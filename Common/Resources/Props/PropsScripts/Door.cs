...
/**-----------------------------------------------------------------------------------------------------------------------
	**                                                   PURPOSE
	*  
	**  1 - Portal door that warps the player to another scene when they enter its portal.
	**  2 - Auto-fills the destination spawn tag from the door's node name when left blank.
	*
*-----------------------------------------------------------------------------------------------------------------------**/
