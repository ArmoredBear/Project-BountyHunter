...
public partial class Skeleton : CharacterBody2D
{
    ...
    {
        GD.Print("SCRIPT - SKELETON - : Transition: " + _currentState + " -> " + newState);
        ...
        if (newState == State.Attack)
        {
            ...
            if (Animation_Player != null)
            {
                GD.Print("CHANGE STATE -- Playing Skeleton_Attack animation");
        ...
        else if (newState == State.Chase)
        {
            if (Animation_Sprite != null)
            {
                Animation_Sprite.Play("Skeleton_Pursuit");
            }
        }
    ...
    private void HandlePatrol()
    {
        ...
        if (Animation_Sprite != null) Animation_Sprite.Play("Skeleton_Pursuit");
    }
    ...
    {
        GD.Print($"SCRIPT - SKELETON - : Vida do inimigo alterada para: {newHealth}");
    }
    ...
    public void On_AttackHitbox_AreaEntered(Node2D _area)
    {
        ...
        {
            GD.Print("Skeleton hit the player!");
