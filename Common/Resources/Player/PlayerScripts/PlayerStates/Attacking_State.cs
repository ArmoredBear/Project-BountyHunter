...
/**-----------------------------------------------------------------------------------------------------------------------
	**                                                   PURPOSE
	*  
	**  1 - Handles the attacking (light attack) player state.
	**  2 - Plays the light attack animation, flips the sprite and collider based on the facing direction, and transitions to Idle when the animation finishes.
	*
*-----------------------------------------------------------------------------------------------------------------------**/
